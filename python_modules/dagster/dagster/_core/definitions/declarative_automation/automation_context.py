...
class AutomationContext:
    ...
    def cursor(self) -> Optional[str]:
        ...
        return self._node_cursor.get_extra_state(as_type=str) if self._node_cursor else None
    ...
    def get_extra_state(self, as_type: Type[T_ExtraState]) -> Optional[T_ExtraState]:
        return self._node_cursor.get_extra_state(as_type=as_type) if self._node_cursor else None
